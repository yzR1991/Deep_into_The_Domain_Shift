...
class net_MCD(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        ...
        self.F1 = ClassifierHead(input_dim = hidden_dim // 2, output_dim = output_dim)
        self.F2 = ClassifierHead(input_dim = hidden_dim // 2, output_dim = output_dim)
...
class net_DANN(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        ...
        self.layer2 = nn.Sequential(nn.BatchNorm1d(hidden_dim // 2,momentum=0.5),
                                   nn.Tanh(),
                                   nn.Linear(hidden_dim // 2,output_dim))
        self.classifier = DomainClassifier(input_dim = hidden_dim // 2, output_dim = 1)
